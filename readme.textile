...
You can install all dependencies with "Bundler":http://gembundler.com/ them with the provided script:
...
In case of a *LoadError*, please make sure *Rubygems* is used (see http://gist.github.com/54177).
