...
We try to always compare the latest versions of both libraries.
Right now we use: *Savon 0.7.6* and *Handsoap 1.1.7* and *Soap4r* running on *Ruby 1.8.7* and *JRuby 1.5.2*.
